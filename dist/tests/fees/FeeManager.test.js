...
const FeeManager_1 = require("../../contracts/fees/FeeManager");
const FeeStructure_1 = require("../../contracts/fees/structures/FeeStructure");
const FeeCalculation_1 = require("../../contracts/fees/libraries/FeeCalculation");
describe('FeeManager', () => {
    let feeManager;
    let owner;
    let user1;
    ...
    beforeEach(() => {
        ...
        user1 = '0xuser1';
        user2 = '0xuser2';
        feeManager = new FeeManager_1.FeeManager(owner);
    });
    ...
    describe('Fee Exemptions', () => {
        it('should apply percentage exemption', () => {
            const exemptionId = feeManager.createExemption(user1, 'TRADE', 'PERCENTAGE', 2000 // 20% exemption
            );
        ...
        it('should apply fixed exemption', () => {
            const exemptionId = feeManager.createExemption(user1, 'TRADE', 'FIXED', 2 // $2 fixed exemption
            );
            const result = feeManager.calculateFeeWithExemption(1000, user1, 'TRADE', exemptionId);
            expect(result.totalFee).toBe(3); // $5 - $2 exemption
        });
        it('should apply full exemption', () => {
            const exemptionId = feeManager.createExemption(user1, 'TRADE', 'FULL', 0);
            const result = feeManager.calculateFeeWithExemption(1000, user1, 'TRADE', exemptionId);
            expect(result.totalFee).toBe(0);
        });
        it('should handle expired exemptions', () => {
            const exemptionId = feeManager.createExemption(user1, 'TRADE', 'PERCENTAGE', 2000, Date.now() - 1000 // Already expired
            );
            expect(() => {
        ...
        it('should revoke exemptions', () => {
            const exemptionId = feeManager.createExemption(user1, 'TRADE', 'PERCENTAGE', 2000);
    ...
    describe('Fee Distribution', () => {
        it('should distribute fees according to configuration', () => {
            let distributedAmounts = new Map();
    ...
    describe('Administrative Functions', () => {
        ...
        it('should update fee structures', () => {
            const newStructure = {
                feeType: FeeStructure_1.FeeType.FIXED,
                baseFee: 10,
                percentageFee: 0,
                minFee: 10,
                maxFee: 10
    ...
    describe('Gas Optimization', () => {
        ...
        it('should optimize fee calculations', () => {
            ...
            const { results, optimizationMetrics } = FeeCalculation_1.FeeCalculation.optimizeFeeCalculation(structure, contexts);
    ...
    describe('Integration Tests', () => {
        it('should handle complex fee calculation scenarios', () => {
            ...
            feeManager.addFeeTier('TRADE', tier);
            feeManager.setUserTier(user1, 'TRADE', tier);
            const exemptionId = feeManager.createExemption(user1, 'TRADE', 'PERCENTAGE', 500 // 5% exemption
            );
...
//# sourceMappingURL=FeeManager.test.js.map