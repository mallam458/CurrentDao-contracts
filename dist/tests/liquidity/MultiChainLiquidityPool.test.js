...
const MultiChainLiquidityPool_1 = require("../../contracts/liquidity/MultiChainLiquidityPool");
describe('MultiChainLiquidityPool', () => {
    ...
    beforeEach(() => {
        pool = new MultiChainLiquidityPool_1.MultiChainLiquidityPool(JSON.parse(JSON.stringify(initialChains)));
    });
...
//# sourceMappingURL=MultiChainLiquidityPool.test.js.map