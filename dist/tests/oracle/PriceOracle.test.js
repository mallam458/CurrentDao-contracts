...
const AggregationLib_1 = require("../../contracts/oracle/libraries/AggregationLib");
describe('PriceOracle', () => {
    ...
    beforeEach(() => {
        ...
        priceOracle = new PriceOracle_1.PriceOracle(owner);
    });
    ...
    describe('Admin Functions', () => {
        ...
        test('should set deviation threshold', () => {
            const threshold = new OracleStructure_1.DeviationThreshold(assetId, 1000, 3600, 5);
...
describe('AggregationLib', () => {
    describe('calculateWeightedAverage', () => {
        test('should calculate correct weighted average', () => {
            const priceFeeds = [
                new OracleStructure_1.PriceFeed("0xOracle1", "0xAsset1", 1000000n, Date.now(), new Uint8Array()),
                new OracleStructure_1.PriceFeed("0xOracle2", "0xAsset1", 2000000n, Date.now(), new Uint8Array()),
                new OracleStructure_1.PriceFeed("0xOracle3", "0xAsset1", 3000000n, Date.now(), new Uint8Array())
            ];
            const oracles = {
                "0xOracle1": new OracleStructure_1.Oracle("0xOracle1", {}, 100),
                "0xOracle2": new OracleStructure_1.Oracle("0xOracle2", {}, 200),
                "0xOracle3": new OracleStructure_1.Oracle("0xOracle3", {}, 300)
            };
            // Set all feeds as valid
            priceFeeds.forEach(feed => feed.isValid = true);
            const result = AggregationLib_1.AggregationLib.calculateWeightedAverage(priceFeeds, oracles);
        ...
        test('should handle empty price feeds', () => {
            const result = AggregationLib_1.AggregationLib.calculateWeightedAverage([], {});
    ...
    describe('calculateStandardDeviation', () => {
        test('should calculate correct standard deviation', () => {
            ...
            const mean = 2500000n;
            const stdDev = AggregationLib_1.AggregationLib.calculateStandardDeviation(prices, mean);
    ...
    describe('calculateDeviationPercent', () => {
        test('should calculate correct deviation percentage', () => {
            ...
            const deviation = AggregationLib_1.AggregationLib.calculateDeviationPercent(newPrice, referencePrice);
    ...
    describe('detectOutliers', () => {
        test('should detect outliers in price data', () => {
            ...
            const outliers = AggregationLib_1.AggregationLib.detectOutliers(prices);
    ...
    describe('Automated Updates', () => {
        ...
        test('should enable automated updates', () => {
            ...
            const config = new OracleStructure_1.OracleConfig();
    ...
    describe('Gas Optimization Tests', () => {
        ...
        test('should use optimized aggregation methods', () => {
            ...
            const mean = 1100000n;
            const stdDev = AggregationLib_1.AggregationLib.calculateStandardDeviationOptimized(prices, mean);
            expect(stdDev).toBeGreaterThan(0n);
            const sqrt = AggregationLib_1.AggregationLib.sqrtOptimized(1000000n);
...
//# sourceMappingURL=PriceOracle.test.js.map