...
exports.deployBatchProcessor = deployBatchProcessor;
 ...
 */
async function deployBatchProcessor(config) {
    ...
    try {
        ...
        const processor = new BatchProcessor_1.BatchProcessor(batchConfig);
 ...
 */
async function verifyDeployment(processor, deploymentAddress, config) {
 ...
 */
function generateDeploymentAddress(adminAddress) {
 ...
 */
function generateDeploymentHash(address, config) {
...
async function main() {
    ...
    try {
        // Deploy the contract
        const { processor, deploymentAddress, deploymentHash, config: batchConfig } = await deployBatchProcessor(config);
        // Verify deployment
...
//# sourceMappingURL=deploy_batching.js.map