...
exports.DeploymentPresets = void 0;
exports.deployEmergencyContracts = deployEmergencyContracts;
...
class EmergencyContractDeployer {
    ...
    async deployContract(config) {
        ...
        const emergencyPause = new EmergencyPause_1.EmergencyPause(config.governanceMembers, config, this.eventHandlers);
 ...
 */
async function deployEmergencyContracts(config) {
...
class DeploymentPresets {
     ...
     */
    static async deployDevelopment() {
        const config = {
            network: 'development',
            governanceMembers: [
...
exports.DeploymentPresets = DeploymentPresets;
// CLI interface
...
//# sourceMappingURL=deploy_emergency.js.map