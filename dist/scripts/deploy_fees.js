...
exports.FeeSystemDeployer = void 0;
...
class FeeSystemDeployer {
    ...
    async deploy() {
        ...
        try {
            ...
            const feeManager = new FeeManager_1.FeeManager(this.config.owner);
     ...
     */
    async configureFeeStructures(feeManager) {
        // Trading fees - tiered with dynamic adjustment
        const tradingStructure = {
            feeType: FeeStructure_1.FeeType.TIERED,
            baseFee: 1,
        ...
        const transferStructure = {
            feeType: FeeStructure_1.FeeType.HYBRID,
            baseFee: 0.5,
     ...
     */
    async setupFeeDistributions(feeManager) {
     ...
     */
    async setupFeeTiers(feeManager) {
        // Bronze tier
        const bronzeTier = {
            id: 'bronze',
            name: 'Bronze Trader',
     ...
     */
    async createPromotionalExemptions(feeManager) {
        // Create a promotional exemption for early users
        const promotionalExemptionId = feeManager.createExemption('0x0000000000000000000000000000000000000000', // Placeholder for all users
...
exports.FeeSystemDeployer = FeeSystemDeployer;
/**
...
//# sourceMappingURL=deploy_fees.js.map