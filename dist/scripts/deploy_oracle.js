...
exports.PRODUCTION_DEVIATION_THRESHOLDS = exports.PRODUCTION_ORACLE_CONFIGS = exports.PRODUCTION_CONFIG = exports.DEPLOYMENT_CONFIG = exports.deployToMainnet = void 0;
exports.deployPriceOracle = deployPriceOracle;
exports.deployToTestnet = deployToTestnet;
exports.deployToProduction = deployToProduction;
exports.updateOracleConfigurations = updateOracleConfigurations;
exports.healthCheck = healthCheck;
exports.performSecurityAudit = performSecurityAudit;
const PriceOracle_1 = require("../contracts/oracle/PriceOracle");
const OracleStructure_1 = require("../contracts/oracle/structures/OracleStructure");
...
exports.DEPLOYMENT_CONFIG = DEPLOYMENT_CONFIG;
...
exports.PRODUCTION_ORACLE_CONFIGS = PRODUCTION_ORACLE_CONFIGS;
// Production deviation thresholds with stricter settings
const PRODUCTION_DEVIATION_THRESHOLDS = [
    {
        assetId: "0xEnergyAssetToken",
        threshold: new OracleStructure_1.DeviationThreshold("0xEnergyAssetToken", 300, // 3% max deviation (stricter for production)
    ...
    },
    {
        ...
        threshold: new OracleStructure_1.DeviationThreshold("0xSolarToken", 400, // 4% max deviation
        1800, // 30 minutes window
        5 // minimum samples
        )
    },
    {
        assetId: "0xWindToken",
        threshold: new OracleStructure_1.DeviationThreshold("0xWindToken", 500, // 5% max deviation
        3600, // 1 hour window
        3 // minimum samples
        )
    }
];
exports.PRODUCTION_DEVIATION_THRESHOLDS = PRODUCTION_DEVIATION_THRESHOLDS;
/**
...
async function deployPriceOracle() {
    ...
    try {
        ...
        const priceOracle = new PriceOracle_1.PriceOracle(DEPLOYMENT_CONFIG.owner);
        ...
        const prodConfig = new OracleStructure_1.OracleConfig();
        ...
        for (const config of PRODUCTION_ORACLE_CONFIGS) {
            try {
                priceOracle.registerOracle(config.address, config.metadata);
 ...
 */
async function performProductionSecurityChecks(priceOracle) {
    ...
    try {
        ...
        for (const config of PRODUCTION_ORACLE_CONFIGS.slice(0, 3)) {
            const oracleInfo = priceOracle.getOracleInfo(config.address);
 ...
 */
async function verifyProductionDeployment(priceOracle) {
    try {
        ...
        priceOracle.forceAggregation("0xEnergyAssetToken");
 ...
 */
function displayProductionDeploymentSummary(priceOracle) {
 ...
 */
async function verifyDeployment(priceOracle) {
    try {
        // Check active oracles
        const activeOracles = priceOracle.getActiveOracles();
 ...
 */
function displayDeploymentSummary(priceOracle) {
    console.log("\n📋 Deployment Summary");
    console.log("==================");
    console.log(`Contract Owner: ${DEPLOYMENT_CONFIG.owner}`);
    console.log(`Network: ${DEPLOYMENT_CONFIG.network}`);
 ...
 */
async function updateOracleConfigurations() {
    console.log("🔄 Updating oracle configurations...");
    const priceOracle = new PriceOracle_1.PriceOracle(DEPLOYMENT_CONFIG.owner);
    // Example: Update oracle reputation
    for (const config of ORACLE_CONFIGS) {
        try {
            priceOracle.updateOracleReputation(config.address, 10);
...
//# sourceMappingURL=deploy_oracle.js.map