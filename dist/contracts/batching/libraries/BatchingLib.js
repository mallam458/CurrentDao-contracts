...
class BatchingLib {
     ...
     */
    static generateBatchId(submitter, timestamp, nonce) {
     ...
     */
    static generateTransactionId(from, timestamp, nonce) {
     ...
     */
    static sortTransactionsByPriority(transactions) {
     ...
     */
    static groupTransactionsByPriority(transactions) {
        const groups = {
            [BatchStructure_1.TransactionPriority.LOW]: [],
            [BatchStructure_1.TransactionPriority.MEDIUM]: [],
            [BatchStructure_1.TransactionPriority.HIGH]: [],
            [BatchStructure_1.TransactionPriority.URGENT]: [],
            [BatchStructure_1.TransactionPriority.EMERGENCY]: []
        };
     ...
     */
    static validateBatch(batch, config) {
        const errors = [];
        const warnings = [];
        // Check batch size
     ...
     */
    static optimizeTransactions(transactions, config) {
        ...
        if (config.gasPriceThreshold > 0) {
            optimized = optimized.filter(tx => tx.priority >= config.priorityThreshold ||
                tx.priority === BatchStructure_1.TransactionPriority.EMERGENCY);
        }
        return optimized;
    }
    /**
    ...
    static groupSimilarTransactions(transactions) {
        const groups = {
            [BatchStructure_1.TransactionType.TRANSFER]: [],
            [BatchStructure_1.TransactionType.APPROVE]: [],
            [BatchStructure_1.TransactionType.MINT]: [],
            [BatchStructure_1.TransactionType.BURN]: [],
            [BatchStructure_1.TransactionType.STAKE]: [],
            [BatchStructure_1.TransactionType.UNSTAKE]: [],
            [BatchStructure_1.TransactionType.SWAP]: [],
            [BatchStructure_1.TransactionType.CUSTOM]: []
        };
     ...
     */
    static optimizeGasLimit(transaction) {
        const baseGasLimits = {
            [BatchStructure_1.TransactionType.TRANSFER]: 21000,
            [BatchStructure_1.TransactionType.APPROVE]: 45000,
            [BatchStructure_1.TransactionType.MINT]: 80000,
            [BatchStructure_1.TransactionType.BURN]: 50000,
            [BatchStructure_1.TransactionType.STAKE]: 100000,
            [BatchStructure_1.TransactionType.UNSTAKE]: 90000,
            [BatchStructure_1.TransactionType.SWAP]: 150000,
            [BatchStructure_1.TransactionType.CUSTOM]: 100000
        };
     ...
     */
    static estimateGasCost(transactions) {
     ...
     */
    static calculateGasSavings(originalTransactions, optimizedTransactions) {
     ...
     */
    static estimateExecutionTime(transactions) {
        const baseTimePerTransaction = 50; // 50ms base per transaction
        const complexityMultiplier = {
            [BatchStructure_1.TransactionType.TRANSFER]: 1.0,
            [BatchStructure_1.TransactionType.APPROVE]: 1.2,
            [BatchStructure_1.TransactionType.MINT]: 1.5,
            [BatchStructure_1.TransactionType.BURN]: 1.3,
            [BatchStructure_1.TransactionType.STAKE]: 2.0,
            [BatchStructure_1.TransactionType.UNSTAKE]: 1.8,
            [BatchStructure_1.TransactionType.SWAP]: 2.5,
            [BatchStructure_1.TransactionType.CUSTOM]: 2.0
        };
     ...
     */
    static createRollbackData(transaction, beforeState, afterState) {
        return {
     ...
     */
    static canRollback(transactionType) {
     ...
     * @returns Batch hash
     */
    static generateBatchHash(batch) {
        const data = {
            id: batch.id,
...
exports.BatchingLib = BatchingLib;
//# sourceMappingURL=BatchingLib.js.map