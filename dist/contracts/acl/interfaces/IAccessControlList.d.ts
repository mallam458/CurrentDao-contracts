...
export declare enum EmergencyActionType {
...
export declare enum GovernanceVoteChoice {
    FOR = "FOR",
    AGAINST = "AGAINST",
    ABSTAIN = "ABSTAIN"
}
...
export declare const ACL_ERROR: {
    ...
    readonly PERMISSION_ALREADY_EXISTS: "PERMISSION_ALREADY_EXISTS";
    readonly INVALID_GOVERNANCE_MEMBER: "INVALID_GOVERNANCE_MEMBER";
    readonly PROPOSAL_NOT_FOUND: "PROPOSAL_NOT_FOUND";
    readonly PROPOSAL_NOT_APPROVED: "PROPOSAL_NOT_APPROVED";
    readonly PROPOSAL_NOT_EXECUTABLE: "PROPOSAL_NOT_EXECUTABLE";
    readonly ACCESS_DENIED: "ACCESS_DENIED";
    readonly EMERGENCY_LOCKDOWN: "EMERGENCY_LOCKDOWN";
    readonly FUNCTION_LOCKED: "FUNCTION_LOCKED";
    readonly GAS_TARGET_EXCEEDED: "GAS_TARGET_EXCEEDED";
};
export declare const DEFAULT_ACL_CONFIG: ACLConfig;
export declare const PREDEFINED_ROLE_IDS: readonly ["SUPER_ADMIN", "DAO_EXECUTIVE", "DAO_GOVERNOR", "TREASURY_MANAGER", "TREASURY_OPERATOR", "COMPLIANCE_ADMIN", "COMPLIANCE_OFFICER", "RISK_MANAGER", "SECURITY_ADMIN", "SECURITY_ANALYST", "EMERGENCY_RESPONDER", "AUDITOR", "ORACLE_MANAGER", "ORACLE_OPERATOR", "REGISTRY_ADMIN", "LIQUIDITY_MANAGER", "LIQUIDITY_OPERATOR", "STAKING_MANAGER", "STAKING_OPERATOR", "FEE_MANAGER", "FEE_OPERATOR", "REPORTING_MANAGER", "SUPPORT_AGENT", "READ_ONLY_OBSERVER"];
//# sourceMappingURL=IAccessControlList.d.ts.map