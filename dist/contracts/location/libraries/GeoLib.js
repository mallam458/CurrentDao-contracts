...
class GeoLib {
    ...
    static ACCURACY_THRESHOLD = 1.0;
    static MAX_VERIFICATION_DISTANCE = 0.1;
    /**
     ...
     */
    static calculateDistance(from, to, method = LocationStructure_1.DistanceMethod.HAVERSINE) {
        switch (method) {
            case LocationStructure_1.DistanceMethod.HAVERSINE:
                return this.haversineDistance(from, to);
            case LocationStructure_1.DistanceMethod.EUCLIDEAN:
                return this.euclideanDistance(from, to);
            case LocationStructure_1.DistanceMethod.MANHATTAN:
     ...
     */
    static haversineDistance(from, to) {
     ...
     */
    static manhattanDistance(from, to) {
     ...
     */
    static isWithinGridZone(coordinates, gridZone) {
        if (gridZone.boundaries.length < 3)
            return false;
     ...
     */
    static generatePrivacyZone(original, privacyLevel) {
        let radius;
        switch (privacyLevel) {
            case 1: // PRIVACY_ZONE
     ...
     */
    static obscureCoordinates(original, radiusKm) {
     ...
     */
    static verifyCoordinates(submitted, expected, toleranceKm = this.MAX_VERIFICATION_DISTANCE) {
     ...
     */
    static findNearestGridZone(coordinates, gridZones) {
     ...
     */
    static validateAccuracy(distance, expectedDistance) {
     ...
     */
    static generateLocationHash(coordinates, precision = 6) {
     ...
     */
    static canTrade(location1, location2, maxDistanceKm) {
